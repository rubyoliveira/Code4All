        ...
        <div className = "copilot">
            ...
            <div className="copilot-bottom">
                <div style={{ display: 'flex' }} className="copilot-search">
                    ...
                    />
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="s-icon s-icon-icon-send" viewBox="0 0 16 16"  style={{ marginLeft: '20px' }} onClick={handleClick} className="copilot-run">
